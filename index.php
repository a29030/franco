        ...
        <div class="header-top">
            <div class="container-fluid">
                ...
                <div class="col-6 header-top__right">
                    <a href="">
                        <i class="fa fa-cog" aria-hidden="true" style="color: grey"></i>
            ...
            <div class="container-fluid">
                ...
                <div class="col-6 col-md-9 col-lg-8">
                    ...
                    <ul class="nav header-bottom__menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#"><b>COLLECTIONS</b></a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col-lg-1 col-md-1 col-3">
                    <div class="row">
                        ...
                        <div class="col-2 header-bottom__icon">
                            <a href="">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                     class="bi bi-heart header-icon" viewBox="0 0 16 16">
                        ...
                        <div class="col-2 header-bottom__icon">
                            <a href="">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                     class="bi bi-cart header-icon" viewBox="0 0 16 16">
            ...
            <div class="col-12 col-xl-4">
                <div class="row">
                    <div class="col-6 col-xl-12">
                        <div class="ads-left-top">
                            <img src="img/ADS/ad2.png" alt="">
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="detail detail-left">
                        ...
                        <span>
                        <svg style="color: grey" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                ...
                <div class="col-5">
                    ...
                    <div class="detail">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="detail__menu detail__menu2">
                                    <a href=""><p>FAQs</p></a>
                                    <a href=""><p>Featured Brands</p></a>
                                    <a href=""><p>Gift Vouchers</p></a>
                                    <a href=""><p>Affiliates</p></a>
                                    <a href=""><p>Specials Gift</p></a>
                ...
                <div class="col-3">
                    ...
                    <div class="detail detail-right">
                        ...
                        <p>
                            <span>
                                <svg color="white" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 text-right footer-bottom__right">
                    <span>
                        <i class="fa fa-cc-visa fa-lg" aria-hidden="true" style="color: white;"></i>
                    </span>
                    <span>
                        <i class="fa fa-cc-paypal fa-lg" aria-hidden="true" style="color: white"></i>
                    </span>
                    <span>
                        <i class="fa fa-cc-mastercard fa-lg" aria-hidden="true" style="color: white"></i>
                    </span>
                    <span>
                        <i class="fa fa-cc-discover fa-lg" aria-hidden="true" style="color: white"></i>
                    </span>
                    <span>
                        <i class="fa fa-cc-amex fa-lg" aria-hidden="true" style="color: white"></i>
                    </span>
                </div>
            </div>
        </div>
